...
![Разные пути создания сайта на движке Wordpress](/assets/images/posts/js/docker-compose/docker-compose-wordpress.png)
